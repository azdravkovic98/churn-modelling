...
data <- read_csv("~/Faks/EFM/churn_modelling/data_with_NA.csv")
...
# kako se u ne bi desilo da se kod njih pojave decimalne vrednosti
# nakon što algoritam dodeli npr. srednje vrednosti na nedostajućim
# mestima
data[, c(10, 11, 12)] <- lapply(data[, c(10, 11, 12)], as.factor)

data.imp <- missForest::missForest(data[, c(4, 9, 10, 11, 12, 13)], maxiter = 10)
